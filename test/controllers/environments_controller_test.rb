...
class EnvironmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create environment" do
    assert_difference('Environment.count') do
      post environments_url, params: { environment: { destination_crt: @environment.destination_crt, name: @environment.name } }, as: :json
    end
  ...
  test "should update environment" do
    patch environment_url(@environment), params: { environment: { destination_crt: @environment.destination_crt, name: @environment.name } }, as: :json
    assert_response 200
  end
